...
extension ViewModelType {
    // swiftlint:disable:next function_parameter_count
    private func setupLoadMorePagingWithParam<T, U>(loadTrigger: Driver<U>,
        ...
        loadingMore: Driver<Bool>) {
            ...
            let loadMoreItems = loadMoreTrigger
                ...
                .do(onNext: { page in
                    ...
                    let totalPage = pageSubject.value.totalPage
                    let newPage = PagingInfo<T>(page: page.page, items: items, totalPage: totalPage)
    ...
    // swiftlint:disable:next function_parameter_count
    private func setupLoadMorePagingWithParam<T, U, V>(loadTrigger: Driver<U>,
                                                       getItems: @escaping (U) -> Observable<PagingInfo<T>>,
                                                       refreshTrigger: Driver<U>,
                                                       refreshItems: @escaping (U) -> Observable<PagingInfo<T>>,
                                                       loadMoreTrigger: Driver<U>,
                                                       loadMoreItems: @escaping (U, Int) -> Observable<PagingInfo<T>>,
                                                       mapper: @escaping (T) -> V) -> (page: BehaviorRelay<PagingInfo<V>>,
        fetchItems: Driver<Void>,
        error: Driver<Error>,
        loading: Driver<Bool>,
        refreshing: Driver<Bool>,
        loadingMore: Driver<Bool>) {
            ...
            let loadMoreItems = loadMoreTrigger
                ...
                .do(onNext: { page in
                    ...
                    let totalPage = pageSubject.value.totalPage
                    let newPage = PagingInfo<V>(page: page.page, items: items, totalPage: totalPage)
                    pageSubject.accept(newPage)
                })
                .mapToVoid()
